...
st.header("📊 Análisis de portafolio con CAPM y Frontera Eficiente")
st.markdown("""
Selecciona hasta 4 acciones para construir un portafolio, visualizar su frontera eficiente y analizar su desempeño con el modelo CAPM.
""")
